...
(function($wnd, $doc){
  ...
  var badBrowser = 'Unable to load Super Dev Mode of "simulator" because\n';
  ...
  $wnd.__gwt_activeModules['simulator'] = {
 ...
 * "/simulator.nocache.js" is the one that loaded us. Normally this happens
...
function computeScriptBase() {
  ...
  $wnd.__gwt_activeModules['simulator'].superdevmode = true;

  var expectedSuffix = '/simulator.nocache.js';
  ...
  $wnd.alert('Unable to load Super Dev Mode version of ' + simulator + ".");
}
;
  ...
  var devModeHookKey = '__gwtDevModeHook:simulator';
  var devModeSessionKey = '__gwtDevModeSession:simulator';

  // Compute some codeserver urls so as the user does not need bookmarklets
  var hostName = $wnd.location.hostname;
  var serverUrl = 'http://' + hostName + ':9876';
  var nocacheUrl = serverUrl + '/simulator/simulator.nocache.js';
  ...
  $wnd.__gwt_activeModules['simulator'].canRedirect = true;
  $wnd.__gwt_activeModules['simulator'].superdevmode = true;
  ...
  $wnd[compileFunction] = function() {
    ...
    compileScript.src = serverUrl +
      '/recompile/simulator?user.agent=' + ua + '&_callback=' + callback;
